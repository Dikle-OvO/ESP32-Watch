...
lv_obj_set_style_bg_color(ui_Screen1, lv_color_hex(0xFDFDFD), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_Screen1, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_bg_img_src( ui_Screen1, &ui_img_152883419, LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_img_src( ui_Screen1, &ui_img_152883419, LV_PART_MAIN | LV_STATE_PRESSED );
...
lv_label_set_text(ui_Label1,"HAPPY EVERYDAY");
...
lv_label_set_text(ui_Label2,"This is a LVGL display test");
...
lv_obj_set_x( ui_TimeLabel, 65 );
lv_obj_set_y( ui_TimeLabel, 52 );
